...
public class KafkaProducerConfig {
    ...
    @Bean
    public NewTopic createVehicleLiveCoordinatesTopic(){
        return new NewTopic("live-coordinates-topic", 2, (short) 1);
    }

    @Bean
    public NewTopic createVehicleLiveCoordinatesMockTopic(){
        return new NewTopic("live-coordinates-mock-topic", 2, (short) 1);
    }
