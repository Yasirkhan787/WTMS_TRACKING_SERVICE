...
import com.yasirkhan.tracking.exceptions.UnauthorizedException;
import com.yasirkhan.tracking.models.UserPrincipal;
import com.yasirkhan.tracking.services.DownstreamJwtService;
...
public class AuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            // Extract Token logic updated for WebSockets
            String authHeader = request.getHeader("Authorization");
            String token = null;

            if (authHeader != null && authHeader.startsWith("Bearer ")) {
                token = authHeader.substring(7);
            } else if (request.getServletPath().startsWith("/tracking")) {
                // FALLBACK FOR WEBSOCKETS: Browsers cannot send headers in WS handshake
            ...
            // Note: Redis revocation check is commented out as per your original file
